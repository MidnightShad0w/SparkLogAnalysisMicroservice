...
public class LogAnomalyDetectionJob {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 2) {
            System.err.println("Usage: LogAnomalyDetectionJob C:\\Users\\admin\\Desktop\\Диплом\\LogAnalysisMicroservice\\SparkService\\data\\logdata.csv Z:\\Диплом\\SparkLogAnalysisMicroservice\\SparkService\\model");
            System.exit(1);
        }
